...
2. Run the arm64 image locally (native on an ARM Mac, qemu elsewhere) and check startup, the endpoints, malformed input, and `docker stop` returning promptly rather than timing out to SIGKILL.
